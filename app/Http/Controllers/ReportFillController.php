...
class ReportFillController extends Controller
{
    ...
    {
        $workPlan = new \ArrayObject(); //deve ser alterado para pegar o plano de ensino aberto para preenchimento
        $workPlan->id = 1; //<- temporário
    ...
    {
        $proximaAba = $request->proximaAba > 0 ? $request->proximaAba : 1;
